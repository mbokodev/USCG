...
export default function EditMyAdPage() {
  ...
  const { data: ad, isLoading, error } = useQuery({
    queryKey: ["my-ad", adId],
    queryFn: () => adsService.getMyAd(adId),
    enabled: !!adId,
  });
  ...
  return (
    <div className="h-full overflow-y-auto pb-6">
      ...
      {/* Form - Note: For seller, this uses the same AdForm but will call seller update endpoint */}
      <AdForm
        mode="edit"
        adId={adId}
